<%-- 
    Document   : share
    Created on : Jan 19, 2016, 11:16:56 PM
    Author     : Sonu
--%>
...
<div id="examp" >
        ...
        <ul id="na">
            ...
            <li><a href="#home">Share Ride</a></li>
...
<div id="a6">
            ...
            <section id="home" style="background:url(images/share1.jpg)  center top; ">
                ...
                <div class="box2 effect7">
                    <segment style="color:0066ff; font-size: 2.5vh;font-size: 2.5vw;text-align: center;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Share a Ride</segment><hr>

                    <form name="share" action="shareride" method="post" onsubmit="return Sharevalid()">
                    <table>
                        <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;">From:&nbsp;&nbsp;
		</td>
                <td><div style="margin-top: 1%;margin-left: 10%;border: 1px solid #DDD;width: 200px;height: 25px;float: left;">
        <img src="images/loc1.jpg" height="60%" width="7.7%"/>
     <input name="x1" id="autocomplete" onFocus="geolocate()" type="text"  placeholder="From" style="font-size: 1vh;font-size: 1vw;background-color: #DCDCDC; border: 0px solid;height:25px;width: 90%;" > </input>
    </div></td>
                        </tr>
                ...
                <td> <div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width: 200px;float: left;height: 25px;">
        <img src="images/loc1.jpg" height="60%" width="7.7%"/>
     <input name="x2" id="autocomplete2" onFocus="geolocate()" type="text"  placeholder="To" style="font-size: 1vh;font-size: 1vw;background-color: #DCDCDC; border: 0px solid;height: 25px;width: 90%;" > </input>
    </div></td>
     ...
     <input type="text" name="x3" id="datepicker"  placeholder="MM/DD/YYYY" style="font-size: 1vh;font-size: 1vw;background-color: #DCDCDC; border: 0px solid;height: 25px;width: 88%;" />
    </div></td>
                          </tr>
                          
                          
                           <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;">Time:&nbsp;&nbsp;
		</td>
        
                <td><div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width:200px;float: left;height: 25px;">
        <img src="images/time1.png" height="70%" width="9.7%"/>
...
<select name="x6">
  ...
  <option value="PM">PM</option>
                          ...
                          <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;">Vehicle Type:&nbsp;&nbsp;
		</td>
        
                <td><div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width:200px;float: left;height: 25px;">
        <img src="images/car.png" height="60%" width="9.7%"/>
      <select name="x7">
  ...
  <option value="Prime">Prime</option>
                          ...
                          <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;">Available Seats:&nbsp;&nbsp;
		</td>
        
                <td><div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width:200px;float: left;height: 25px;">
        <img src="images/seat.jpg" height="60%" width="9.7%"/>
      <select name="x8">
     <option value="1">1</option>
  <option value="2">2</option>
  <option value="3">3</option>
  ...
  <option value="6">6</option>
                           ...
                           <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;">Contact Number:&nbsp;&nbsp;
		</td>
        
                <td><div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width:200px;float: left;height: 25px;">
        <img src="images/conticon.jpg" height="60%" width="9.7%"/>
     <input type="text" maxlength="10" id="" name="x9" placeholder="Contact No." style="font-size: 1vh;font-size: 1vw;background-color: #DCDCDC; border: 0px solid;height: 25px;width: 88%;" />
    </div></td>
                          </tr>
                          
                          
                           <tr>
                            <td style="color:#669900;font-size: 1.5vh;font-size: 1.5vw;"> Price per Seat:&nbsp;&nbsp;
		</td>
        
                <td><div style="margin-top: 4%;margin-left: 10%;border: 1px solid #DDD;width:200px;float: left;height: 25px;">
        <img src="images/price.png" height="60%" width="9.7%"/>
     <input type="text" id="" name="x10" placeholder="Price" style="font-size: 1vh;font-size: 1vw;background-color: #DCDCDC; border: 0px solid;height: 25px;width: 88%;" />
    </div></td>
                          </tr>
                          ...
                          <tr>
                              ...
                              <td>   <div style="margin-top: 15%;margin-left: 80%;width: 100%;float: left;height: 8%;">
            <input type="submit"  value="Share" style="height:100%;width: 100%;font-size: 1.9vh;font-size: 1.9vw;background-color:#e68a00;color:white; " />   
        </div></td>
                          </tr>
