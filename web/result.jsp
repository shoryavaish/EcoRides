<%-- 
    Document   : result
    Created on : Feb 5, 2016, 12:32:36 AM
    Author     : Sonu
--%>
...
<div id="examp" >
        ...
        <ul id="na">
            ...
            <li><a href="#home">Available Rides</a></li>
...
<div id="a6">
           ...
           <section id="home" style="background:url(images/share1.jpg)  center top; ">
               ...
               <div style="height:85%;width:80%;float:left;background-color: white;margin-left: 10%;margin-top: 10px;">
